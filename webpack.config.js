...
const LOCAL_II_CANISTER = 'http://7pdsn-cqaaa-aaaaa-aabcq-cai.localhost:8000/#authorize';
...
const asset_entry = path.join('src', 'auth_client_demo_assets', 'src', 'index.html');
...
module.exports = {
	...
	plugins: [
		...
		new CopyPlugin({
			patterns: [
				{
					from: path.join(__dirname, 'src', 'auth_client_demo_assets', 'assets'),
